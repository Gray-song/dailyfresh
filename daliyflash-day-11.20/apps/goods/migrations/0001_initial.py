    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(verbose_name='商品SPU模型类', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(verbose_name='更新时间', auto_now=True)),
                ('is_delete', models.BooleanField(verbose_name='删除标记', default=False)),
                ('image', models.ImageField(verbose_name='商品图片路径', upload_to='goods')),
            ],
            options={
                'verbose_name': '商品图片',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(verbose_name='商品类图片', upload_to='type')),
            ],
            options={
                'verbose_name': '商品种类',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.ForeignKey(verbose_name='商品类型', to='goods.GoodType')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='sku',
            field=models.ForeignKey(verbose_name='商品 ', to='goods.GoodSKU'),
        ),
    ]
